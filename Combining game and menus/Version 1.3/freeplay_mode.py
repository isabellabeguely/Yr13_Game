...
grid = FreeplayMode(screen,LETTER_FONT,WORD_FONT,startx,starty,words[current_word_index])
grid.show_word = True
grid.word_display_start_time = pygame.time.get_ticks()
grid.word_asked = grid.word

def freeplay_rungame():
    # GAME LOOP
    freeplay_running = True
    while freeplay_running:
        screen.fill("white")
