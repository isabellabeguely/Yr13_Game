...
from inpustSystem import run_game
from inpustSystem import running
...
# --------------------- Main Menu Screen ---------------------
def main_menu():
    state = "menu"  # State control: menu, freeplay, timelimit
    global SCREEN, SCREEN_WIDTH, SCREEN_HEIGHT, running
